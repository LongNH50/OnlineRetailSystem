...
import miu.edu.onlineRetailSystem.auth.AuthenticationService;
import miu.edu.onlineRetailSystem.auth.RegisterRequest;
...
import static miu.edu.onlineRetailSystem.nonDomain.Role.ADMIN;
...
public class OnlineRetailSystemApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // add address just to test customer update
        testAddingAddresses();
    }
    ...
    public void testAddingAddresses() {
        ...
        addressRepository.save(defaultShippingAddress);
        ...
        addressRepository.save(shippingAddress1);
    }
