...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query("select r from Order o join o.customer.reviews r where o.customer.id = :customerId and o.id = :orderId")
    Review findReviewByCustomerAndOrder(@Param("customerId") int customerId, @Param("orderId") int orderId);
